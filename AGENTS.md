...
tengiz ps [-v]        → list apps from Docker (use -v for container and image sizes)
tengiz cleanup [--containers] [--images] [--volumes] [--build-cache] [--all] [--dry-run] [--force] → prune unused Docker resources

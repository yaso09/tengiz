...
tengiz cleanup [--containers] [--images] [--volumes] [--networks] [--build-cache] [--dry-run] → prune unused Docker resources (Tengiz containers protected via `label!=tengiz-app`; volumes opt-in)

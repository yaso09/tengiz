...
tengiz cleanup [--dry-run] [--containers] [--images] [--volumes] [--networks] [--cache] [--all] → reclaim disk by pruning stale containers, dangling images, build cache, volumes, and networks (label-based protection)

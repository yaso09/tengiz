...
tengiz cleanup [--dry-run] [--containers|--images|--volumes|--networks|--cache|--all] → reclaim disk space by removing stale containers, unused images/volumes/networks, and build cache

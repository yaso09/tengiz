...
tengiz cleanup [--dry-run] [--force] [--stats] [--containers|--images|--all-images|--volumes|--networks|--cache] → prune unused Docker resources (label-protected, prompts for confirmation unless --force)

...
### `tengiz logs [-f] [--tail N] [--since timestamp] [--grep pattern] <app>`
...
| `--since` | Show logs since timestamp (e.g. `2024-01-01T00:00:00Z` or `5m`) |
| `--grep` | Filter logs with a case-sensitive pattern |

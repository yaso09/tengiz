...
func (m *mockRTForDeploy) PruneContainers(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRTForDeploy) PruneImages(ctx context.Context, all bool) (uint64, error) { return 0, nil }
func (m *mockRTForDeploy) PruneVolumes(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRTForDeploy) PruneNetworks(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRTForDeploy) PruneBuildCache(ctx context.Context, all bool) (uint64, error) { return 0, nil }
func (m *mockRTForDeploy) DiskUsage(ctx context.Context) (*runtime.DiskUsageInfo, error) { return &runtime.DiskUsageInfo{}, nil }

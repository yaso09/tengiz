...
func (m *mockRTForDeploy) PruneContainers(ctx context.Context) (string, error) { return "", nil }
func (m *mockRTForDeploy) PruneImages(ctx context.Context) (string, error) { return "", nil }
func (m *mockRTForDeploy) PruneVolumes(ctx context.Context) (string, error) { return "", nil }
func (m *mockRTForDeploy) PruneBuildCache(ctx context.Context) (string, error) { return "", nil }
func (m *mockRTForDeploy) PruneSystem(ctx context.Context) (string, error) { return "", nil }

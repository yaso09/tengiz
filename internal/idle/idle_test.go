...
func (m *mockRuntime) PruneContainers(ctx context.Context) error { return nil }
func (m *mockRuntime) PruneImages(ctx context.Context) error { return nil }
func (m *mockRuntime) PruneVolumes(ctx context.Context) error { return nil }
func (m *mockRuntime) PruneNetworks(ctx context.Context) error { return nil }
func (m *mockRuntime) PruneBuildCache(ctx context.Context) error { return nil }
func (m *mockRuntime) CleanupOrphanedContainers(ctx context.Context, activeApps []string) error { return nil }
func (m *mockRuntime) CleanupOrphanedImages(ctx context.Context, activeApps []string) error { return nil }
func (m *mockRuntime) CleanupAppImages(ctx context.Context, appName string) error { return nil }
func (m *mockRuntime) CleanupAppResources(ctx context.Context, appName string) error { return nil }

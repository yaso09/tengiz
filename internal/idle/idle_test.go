...
func (m *mockRuntime) SystemPrune(ctx context.Context, opts runtime.SystemPruneOptions) (*runtime.SystemPruneResult, error) { return &runtime.SystemPruneResult{}, nil }

...
func (m *mockRuntime) PruneContainers(ctx context.Context, opts types.PruneOptions) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }
func (m *mockRuntime) PruneImages(ctx context.Context, opts types.PruneOptions) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }
func (m *mockRuntime) PruneVolumes(ctx context.Context, opts types.PruneOptions) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }
func (m *mockRuntime) PruneNetworks(ctx context.Context, opts types.PruneOptions) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }
func (m *mockRuntime) PruneBuildCache(ctx context.Context, opts types.PruneOptions) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }
func (m *mockRuntime) DiskUsage(ctx context.Context) (*types.CleanupReport, error) { return &types.CleanupReport{}, nil }

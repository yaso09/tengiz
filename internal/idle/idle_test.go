...
func (m *mockRuntime) PruneContainers(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRuntime) PruneImages(ctx context.Context, all bool) (uint64, error) { return 0, nil }
func (m *mockRuntime) PruneVolumes(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRuntime) PruneNetworks(ctx context.Context) (uint64, error) { return 0, nil }
func (m *mockRuntime) PruneBuildCache(ctx context.Context, all bool) (uint64, error) { return 0, nil }

...
func (m *mockRuntime) PruneContainers(ctx context.Context) (*runtime.CleanupResult, error) { return &runtime.CleanupResult{}, nil }
func (m *mockRuntime) PruneImages(ctx context.Context) (*runtime.CleanupResult, error) { return &runtime.CleanupResult{}, nil }
func (m *mockRuntime) PruneVolumes(ctx context.Context) (*runtime.CleanupResult, error) { return &runtime.CleanupResult{}, nil }
func (m *mockRuntime) PruneNetworks(ctx context.Context) (*runtime.CleanupResult, error) { return &runtime.CleanupResult{}, nil }
func (m *mockRuntime) PruneBuildCache(ctx context.Context) (*runtime.CleanupResult, error) { return &runtime.CleanupResult{}, nil }

...
func (m *mockRuntime) PruneOrphanedImages(ctx context.Context) error { return nil }
func (m *mockRuntime) ListOrphanedResources(ctx context.Context) ([]types.OrphanedResource, error) { return nil, nil }
